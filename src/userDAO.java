...
public class userDAO 
{
    ...
    public List<user> listAllUsers() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            user users = new user(email,firstName, lastName, password, birthday, adress_street_num,  adress_street,  adress_city,  adress_state,  adress_zip_code);
            listUser.add(users);
        }        
        resultSet.close();
        disconnect();        
    ...
    public user getUser(String email) throws SQLException {
        ...
        if (resultSet.next()) {
            ...
            user = new user(email, firstName, lastName, password, birthday, adress_street_num,  adress_street,  adress_city,  adress_state,  adress_zip_code);
        }
    ...
    public void init() throws SQLException, FileNotFoundException, IOException{
        ...
        String[] TUPLES = {("insert into User(email, firstName, lastName, password, birthday, adress_street_num, adress_street, adress_city, adress_state, adress_zip_code)"+
